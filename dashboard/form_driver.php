<?php
  ...
  if(isset($_POST['submit-form-driver'])){
    $nama = $_POST['txt_nama'];
    $usia = $_POST['txt_usia'];
    $nomer = $_POST['txt_nomer'];
    $alamat = $_POST['txt_alamat'];


    $quey_insert = "INSERT INTO tb_drivers (nama, usia, no_wa, alamat)
    VALUES ('$nama', '$usia', '$nomer', '$alamat')";

    $res = mysqli_query($conn, $quey_insert);

    if($res){
      header("Location: form_angkot.php");
      exit();
    }else{
